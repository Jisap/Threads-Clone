...
export const ourFileRouter = {
    ...
    media: f({ image: { maxFileSize: "4MB", maxFileCount: 1 } })  // Define as many FileRoutes as you like, each with a unique routeSlug
        
        .middleware(async (req) => {                              // Set permissions and file types for this FileRoute  
